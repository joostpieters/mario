...
// VALIDATIONS
	...
	/**
	 * the plant starts moving to the right
	 * @effect the orientation is set to right and the horizontal speed is set
	 * 			| setOrientationRight()
	 * 			| setXSpeed(Plant.getStartSpeed())
	 */
	@Override
	...
	/**
	 * the plant starts moving to the left
	 * @effect the orientation is set to left and the horizontal speed is set
	 * 			| setOrientationLeft()
	 * 			| setXSpeed(Plant.getStartSpeed())
	 */
	@Override
