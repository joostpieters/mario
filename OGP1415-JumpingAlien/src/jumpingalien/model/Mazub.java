...
//	}
	...
	public void advanceTime(double dt) throws IllegalDtException {
		...
		// waarom stond/staat dit weggecomment? -> er is nog wel iets mis met de hitpoints :(
//		int touchedPlants = this.getWorld().touchedPlants(this.getXPos(), this.getYPos(),
//				this.getXDim(), this.getYDim());
