...
//	SETTERS	
	...
	/**
	 * Returns true if this world has the given Mazub as alien
	 * @param alien
	 * 			the alien to check
	...
	/**
	 * Returns true if this world has the given Buzam as buzam
	 * @param buzam
	 * 			the buzam to check
	 * @return true if the buzam of the world equals the given buzam
	 * 			|  this.getBuzam() == buzam
	 */
	@Raw
...
//	VALIDATIONS
	...
	public void advanceTime(double dt) throws IllegalDtException {
		...
		for (GameObject object: this.listAllGameObjects()) {
			if (object != null && object.getProgram() != null) {
